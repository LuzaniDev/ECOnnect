...
class ScheduleDialog(QDialog):
    def __init__(self, parent, client_count: int, template_name: str):
        ...
        self.radio_antes = QRadioButton("Dias ANTES do vencimento:")
